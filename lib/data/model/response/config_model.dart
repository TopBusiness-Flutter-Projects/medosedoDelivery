...
class BaseUrls {
  ...
  String? _medosedoDeliveryImageUrl;
  ...
  BaseUrls(
      {String? productImageUrl,
        ...
        String? medosedoDeliveryImageUrl,
      }) {
    ...
    _medosedoDeliveryImageUrl = medosedoDeliveryImageUrl;
  }
  ...
  String? get medosedoDeliveryImageUrl => _medosedoDeliveryImageUrl;
  ...
  BaseUrls.fromJson(Map<String, dynamic> json) {
    ...
    _medosedoDeliveryImageUrl = json['delivery_man_image_url'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['delivery_man_image_url'] = _medosedoDeliveryImageUrl;
    return data;
  }
}
