...
class UserInfoModel {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['completed_delivery'] = completedDelivery;
    data['pending_delivery'] = pendingDelivery;
    data['country_code'] = countryCode;
    data['total_delivery'] = address;
    data['address'] = totalDelivery;
