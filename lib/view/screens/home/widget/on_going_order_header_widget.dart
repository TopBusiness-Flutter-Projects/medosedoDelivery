...
class OngoingOrderHeader extends StatelessWidget {
  ...
  const OngoingOrderHeader(
      {Key? key, this.orderModel, this.index, this.isExpanded = false})
      : super(key: key);
                        ...
                        ? Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Flexible(
                                  child: Text(orderModel!.expectedDate ?? '',
                                      style: rubikRegular.copyWith(
                                          fontSize: Dimensions.fontSizeSmall)),
                                ),
                ...
                children: [
                  Row(
                    children: [
                      SizedBox(
                          width: Dimensions.iconSizeDefault,
                          child: Image.asset(Images.sellerIcon)),
                      SizedBox(width: Dimensions.paddingSizeSmall),
                      Text('seller'.tr,
                          style: rubikMedium.copyWith(
                    ...
                    children: [
                      Column(
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsets.only(
                                left: Dimensions.paddingSizeSmall, top: 2),
                            child: Container(
